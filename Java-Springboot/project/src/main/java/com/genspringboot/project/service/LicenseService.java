...
public class LicenseService {
    ...
    public List<License> buscarPorClase (String clase){
        return licenseRepository.findAllClaseLicencia(clase);
    }

    public List<License> buscarPorEstado(String estado){
        return licenseRepository.findAllEstadoLicencia(estado);
    }

    public List<License> buscarPorFechaVencimiento(Date fechaVencimiento){
        return licenseRepository.findAllfechaVencimientoLicencia(fechaVencimiento);
    }
